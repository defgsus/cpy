...
/* generated by lolpig on 2016-12-29 16:23:29.794285 */
...
extern "C" {
    ...
    {
        /* sq_length */         static_cast<lenfunc>        (vec_base_len),
        /* sq_concat */         static_cast<binaryfunc>     (NULL),
        /* sq_repeat */         static_cast<ssizeargfunc>   (NULL),
        /* sq_item */           static_cast<ssizeargfunc>   (vec_base_getitem),
        /* was_sq_slice */      static_cast<void*>          (NULL),
        /* sq_ass_item */       static_cast<ssizeobjargproc>(vec_base_setitem),
    ...
    static PyTypeObject VectorBase_type_struct =
    {
        ...
        /* tp_name */           static_cast<const char*>        ("vec.vec_base"),
        /* tp_basicsize */      static_cast<Py_ssize_t>         (256),
        /* tp_itemsize */       static_cast<Py_ssize_t>         (NULL),
        /* tp_dealloc */        static_cast<destructor>         (vec_base_free),
        ...
        /* tp_repr */           static_cast<reprfunc>           (vec_base_repr),
        ...
        /* tp_new */            reinterpret_cast<newfunc>       (vec_base_new),
    ...
    bool initialize_class_vec_base(PyObject* module)
    {
        if (0 != PyType_Ready(&VectorBase_type_struct))
        {
            CPPY_ERROR("Failed to readify class vec_base for Python module");
            return false;
        }

        PyObject* object = reinterpret_cast<PyObject*>(&VectorBase_type_struct);
        Py_INCREF(object);
        if (0 != PyModule_AddObject(module, "vec_base", object))
        {
            Py_DECREF(object);
            CPPY_ERROR("Failed to add class vec_base to Python module");
            return false;
        }
        return true;
    }
...
namespace {
    ...
    PyMODINIT_FUNC create_module_vec_func()
    {
        ...
        initialize_class_vec_base(module);
